...
const inviteCodes = ['T010-vx3Qh8e9ACjVWnYaS5kRrbA', 'T012a1nTlrK8LPBsCjVWnYaS5kRrbA', 'T0205KkcBUZcpBKDVl-m4KJwCjVWnYaS5kRrbA'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    //Node.js用户请在jdCookie.js处填写京东ck;
    const shareCodes = $.isNode() ? require('./JDWXX_jd_job_jd_FactoryShareCodes.js') : '';
