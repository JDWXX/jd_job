...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'hnyn3j5q6xitdiv5r54bx3zqha@mluaqp25jqdzoaiyb4eb3viclm@mh5uulbrvnknkjxynyusmgjglp4tcmixyorzsgq@7oivz2mjbmnx56hxie4mesldxft422tev5dtgqa@bw2eckbfemfiba42bf52kidnvz6rr4je7cmp7ha@ebxm5lgxoknqdtiju2haj6ghvquprhmxicgrvka@4npkonnsy7xi2ylxunqzdhztgqr3shzd6vdfxra@cd2lbjgriwpzsetjdo4i5t6s3jguvzlapilphxy@3nds3dh2ebzau6whfis7kg2h3q3h7wlwy7o5jii',
...
!(async () => {
  ...
  if(JDWXX_ZL == "JDWXX"){
    ...
    // shareCodesArr.push("hnyn3j5q6xitdiv5r54bx3zqha@mluaqp25jqdzoaiyb4eb3viclm@mh5uulbrvnknkjxynyusmgjglp4tcmixyorzsgq@7oivz2mjbmnx56hxie4mesldxft422tev5dtgqa@bw2eckbfemfiba42bf52kidnvz6rr4je7cmp7ha@ebxm5lgxoknqdtiju2haj6ghvquprhmxicgrvka@4npkonnsy7xi2ylxunqzdhztgqr3shzd6vdfxra@cd2lbjgriwpzsetjdo4i5t6s3jguvzlapilphxy@3nds3dh2ebzau6whfis7kg2h3q3h7wlwy7o5jii")
  }
...
async function jdPlantBean() {
  try {
    ...
    if ($.plantBeanIndexResult && $.plantBeanIndexResult.code === '0' && $.plantBeanIndexResult.data) {
      if($.plantBeanIndexResult.data && $.plantBeanIndexResult.data.jwordShareInfo && $.plantBeanIndexResult.data.jwordShareInfo.shareUrl){
  ...
  async function jdPlantBean() {
    ...
    if ($.plantBeanIndexResult.code === "0") {
      if($.plantBeanIndexResult.data && $.plantBeanIndexResult.data.jwordShareInfo && $.plantBeanIndexResult.data.jwordShareInfo.shareUrl){
        const shareUrl = $.plantBeanIndexResult.data.jwordShareInfo.shareUrl;
        $.myPlantUuid = getParam(shareUrl, "plantUuid");
        console.log(`【京东账号${$.index}（${$.UserName}）种豆得豆互助码】${$.myPlantUuid}`);
        shareCodesdq += $.myPlantUuid + "@"
      }
