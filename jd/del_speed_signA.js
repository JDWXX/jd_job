...
[task_local]
#京东极速版任务A-奇数号
21 3,8,16 * * * jd_speed_sign.js, tag=京东极速版任务A-奇数号, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "21 3,8,16 * * *" script-path=jd_speed_sign.js,tag=京东极速版任务A-奇数号

===============Surge=================
京东极速版任务A-奇数号 = type=cron,cronexp="21 3,8,16 * * *",wake-system=1,timeout=33600,script-path=jd_speed_sign.js

============小火箭=========
京东极速版任务A-奇数号 = type=cron,script-path=jd_speed_sign.js, cronexpr="21 3,8,16 * * *", timeout=33600, enable=true
*/

const $ = new Env('京东极速版任务A-奇数号');
