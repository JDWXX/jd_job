...
function followShop() {
    return new Promise(resolve => {
        let body = `activityId=74c66a86bc444402be5e2129b13b35d2&pin=${encodeURIComponent($.myPingData.secretPin)}&actorUuid=${$.actorUuid}&taskType=23&taskValue=1000009621&shareUuid=${$.shareUuid ? $.shareUuid : 'ca2a2f6f666c45f996438de5ec5dc9d0'}`
...
function getPrize() {
    return new Promise(resolve => {
        let body = `activityId=74c66a86bc444402be5e2129b13b35d2&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'ca2a2f6f666c45f996438de5ec5dc9d0'}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function saveTask(type,value) {
    return new Promise(resolve => {
        let body = `activityId=74c66a86bc444402be5e2129b13b35d2&pin=${encodeURIComponent($.myPingData.secretPin)}&taskType=${type}&taskValue=${value}&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '"ca2a2f6f666c45f996438de5ec5dc9d0"'}`
...
async function drawContent() {
    return new Promise(resolve => {
        ...
        $.post(taskPostUrl('/dingzhi/taskact/common/drawContent', body, `https://lzdz1-isv.isvjcloud.com/dingzhi/sep2021/maleGodDay/activity/805745?activityId=74c66a86bc444402be5e2129b13b35d2&shareUuid=${$.shareUuid ? $.shareUuid : 'ca2a2f6f666c45f996438de5ec5dc9d0'}`), async (err, resp, data) => {
            try {
                if (err) {
                    console.log(`${$.name} API请求失败，请检查网路重试`)
                } else {
...
async function startDraw(type) {
    return new Promise(resolve => {
        let body = `activityId=74c66a86bc444402be5e2129b13b35d2&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'ca2a2f6f666c45f996438de5ec5dc9d0'}&pin=${encodeURIComponent($.myPingData.secretPin)}&type=${type}`
        $.post(taskPostUrl('/dingzhi/sep2021/maleGodDay/startDraw', body, `https://lzdz1-isv.isvjcloud.com/dingzhi/sep2021/maleGodDay/activity/805745?activityId=74c66a86bc444402be5e2129b13b35d2&shareUuid=${$.shareUuid ? $.shareUuid : 'ca2a2f6f666c45f996438de5ec5dc9d0'}`), async (err, resp, data) => {
            try {
                if (err) {
                    console.log(`${$.name} API请求失败，请检查网路重试`)
                } else {
...
function taskPostUrl(url, body, referer) {
    return {
        ...
        headers: {
            ...
            "Referer": referer ? referer : `https://lzdz1-isv.isvjcloud.com/lzclient/dz/2021jan/eliminateGame/0713eliminate/?activityId=735c30216dc640638ceb6e63ff6d8b17&shareUuid=${$.shareUuid ? $.shareUuid : 'ca2a2f6f666c45f996438de5ec5dc9d0'}&adsource=&shareuserid4minipg=u%2FcWHIy7%2Fx3Ij%20HjfbnnePkaL5GGqMTUc8u%2Fotw2E%20a7Ak3lgFoFQlZmf45w8Jzw&shopid=0&lng=114.062541&lat=29.541254&sid=57b59835c68ed8959d124d644f61c58w&un_area=4_48201_54794_0`,
            "User-Agent": UA,
