...
const inviteCodes = [
  'T010-vx3Qh8e9ACjVQmoaT5kRrbA@T012a1nTlrK8LPBsCjVQmoaT5kRrbA@T0205KkcBUZcpBKDVl-m4KJwCjVQmoaT5kRrbA@T0205KkcG3ZmrxWNaEWB4atuCjVQmoaT5kRrbA@T018a1nTlJaULfRqIBn1lgCjVQmoaT5kRrbA@T0205KkcNGhZvz2pVF2P6rNRCjVQmoaT5kRrbA',
  'T010-vx3Qh8e9ACjVQmoaT5kRrbA@T012a1nTlrK8LPBsCjVQmoaT5kRrbA@T0205KkcBUZcpBKDVl-m4KJwCjVQmoaT5kRrbA@T0205KkcG3ZmrxWNaEWB4atuCjVQmoaT5kRrbA@T018a1nTlJaULfRqIBn1lgCjVQmoaT5kRrbA@T0205KkcNGhZvz2pVF2P6rNRCjVQmoaT5kRrbA',
];
      ...
      $.post(url, async (err, resp, data) => {
        try {
          ...
          if (data.data.bizCode === 0) {
            ...
            if(invites && invites[0] && invites[0]['assistTaskDetailVo'] && invites[0]['assistTaskDetailVo']['taskToken']){
              console.log(`【京东账号${$.index}（${$.UserName}）闪购盲盒互助码】${invites && invites[0]['assistTaskDetailVo']['taskToken']}`)
              shareCodesdq += invites && invites[0]['assistTaskDetailVo']['taskToken'] + "@"
            }
          }
        } catch (e) {
          $.logErr(e, resp);
