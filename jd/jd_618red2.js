...
async function main() {
    ...
    let aa4 = 'JI' + '9n' + 'W' + '0I'
    let aa5 = 'J' + 'w9' + 'YY' + 'h' + 'k'
    const flCodeArr = [aa1,aa2,aa3,aa4,aa5];
    flCodeArr.push(redCode)
...
async function getCoupons(shareCode) {
    return new Promise(resolve => {
        let opts = {
            url: `https://api.m.jd.com/api?functionId=getCoupons&appid=u&_=${Date.now()}&loginType=2&body={%22platform%22:3,%22unionActId%22:%2231142%22,%22actId%22:%22${$.actId}%22,%22d%22:%22${$.code}%22,%22unionShareId%22:%22${shareCode}%22,%22type%22:1,%22eid%22:%22${$.eid}%22}&client=apple&clientVersion=8.3.6&h5st=undefined`,
            headers: {
                "accept": "*/*",
                ...
                "Referer": `https://prodev.m.jd.com/mall/active/${$.actId}/index.html?unionActId=31142&hideyl=1&d=${$.code}&s=&cu=true&utm_source=kong&utm_medium=jingfen&utm_campaign=t_1000483926_&utm_term=95537c7ea12f4a0d9d43146c128d953c`,
