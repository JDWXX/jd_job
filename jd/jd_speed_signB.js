...
[task_local]
#京东极速版任务B-偶数号
21 4,15 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, tag=京东极速版任务B-偶数号, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "21 4,15 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js,tag=京东极速版任务B-偶数号

===============Surge=================
京东极速版任务B-偶数号 = type=cron,cronexp="21 4,15 * * *",wake-system=1,timeout=33600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js

============小火箭=========
京东极速版任务B-偶数号 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, cronexpr="21 4,15 * * *", timeout=33600, enable=true
*/

const $ = new Env('京东极速版任务B-偶数号');
...
function taskUrl(_0x7683x2, _0x7683x3 = {}) {
  ...
  console.log(`${__Oxb24bc[0x8]}${JD_API_HOST}${__Oxb24bc[0x9]}${_0x7683x2}${__Oxb24bc[0xa]}${escape(JSON[__Oxb24bc[0x1]](_0x7683x3))}${__Oxb24bc[0xb]}${_0x7683x4}${__Oxb24bc[0xc]}${_0x7683x8}${__Oxb24bc[0x8]}`)
  return {
