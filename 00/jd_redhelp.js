...
var __Oxf2af0 = ["isNode", "./jdCookie20", "", "./function/krh5st", "CODENHJ", "env", "CODENHJZL", "false", "push", "forEach", "keys", "JD_DEBUG", "log", "filter", "CookieJD", "getdata", "CookieJD2", "cookie", "map", "CookiesJD", "[]", "toObj", "shareCode", "getAuthorCodeListerr", "getHours", "done", "finally", "❌ ", "name", ", 失败! 原因: ", "!", "catch", "【提示】请先获取京东账号一cookie    直接使用NobyDa的京东签到获取", "https://bean.m.jd.com/bean/signIndex.action", "msg", "nowTime", "now", "结束时间 ", "当前时间 ", "http://code.kingran.ga/nhj.json", "bUtSWlZzOCxtd1JTcXk3LG10Um4zZ0YsbXRSeUdhOSxtdFIwMldXLG1LUkJmOU8sbXRSMDJXVyxtS1JCZjlP", ",", "split", "base64", "from", "length", "UserName", "match", "index", "isLogin", "nickName", "loginmsg", "random", "floor", "code", "UA", "max", "hotFlag", "newCookie", "jfCk", "url1", "url2", "eid", "用户未登录", ",初始化1失败,可能黑号", ",初始化2失败,可能黑号", "actId", "3re5ajBZWA71ygjVnAz9kbaU1tfw", "wait", "true", "https://api.m.jd.com/api?functionId=shareUnionCoupon&appid=u&_=", "&loginType=2&body={%22unionActId%22:%2231155%22,%22actId%22:%22", "%22,%22platform%22:4,%22unionShareId%22:%22", "%22,%22d%22:%22", "%22,%22supportPic%22:2,%22supportLuckyCode%22:0,%22eid%22:%22", "%22}&client=apple&clientVersion=8.3.6", "zh-cn", "gzip, deflate, br", " ", "toStr", "object", "data", "shareUrl", "助力码:", "logErr", "get", "https://gia.jd.com/fcf.html?a=", "a", "d=", "d", "application/x-www-form-urlencoded;charset=UTF-8", "*_*", "indexOf", "parse", "京豆api返回数据为空，请检查自身原因", "post", "abcdef0123456789", "charAt", "?", "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88", "fill", "join", "ckInArr", "getTime", "substr", ".", "__jda=", ";__jdc=", ";", "31155", "u", "getCoupons", "apple", "8.3.6", "6a98d", "https://api.m.jd.com/api?functionId=", "functionId", "&appid=", "appid", "&_=", "&loginType=2&body=", "stringify", "&client=", "client", "&clientVersion=", "clientVersion", "&h5st=", " API请求失败，请检查网路重试", "结果：", "上限", "shareId", "undefined", "joinNum", "当前", "joinSuffix", ":", "type", "获得红包：", "discount", "元", "获得优惠券：️满", "quota", "减", "获得打折券：满", "打", "折", "获得未知", "headers", "set-cookie", "Set-Cookie", "trim", "=", "replace", "; ", "location", "Location", "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", "round", "substring", "utf8", "JM9F1ywUPwflvMIpYPok0tt5k9kW4ArJEU3lfLhxBqw=", "CJK=", "CNKmCNKmCNKjCNKmCM0mCNKmBJKmCNKjCNKmCNKmCNKmCNKm", "Ctu=", "1.2.0", "com.jd.jdlite", "jdapp;iPhone;11.1.4;;;M/5.0;appBuild/168210;jdSupportDarkMode/1;ef/1;ep/", ";Mozilla/5.0 (Linux; Android 10; WLZ-AN01 Build/HUAWEIWLZ-AN01; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.72 MQQBrowser/6.2 TBS/045837 Mobile Safari/537.36", "https://u.jd.com/", "?s=", "删除", "版本号，js会定", "期弹窗，", "还请支持我们的工作", "jsjia", "mi.com"];
const jdCookieNode = $[__Oxf2af0[0x0]]() ? require(__Oxf2af0[0x1]) : __Oxf2af0[0x2];
const getH5st = require(__Oxf2af0[0x3]);
const endTime = 1673798399000;
let krflCode = null;
if ($[__Oxf2af0[0x0]]() && process[__Oxf2af0[0x5]][__Oxf2af0[0x4]]) {
    krflCode = process[__Oxf2af0[0x5]][__Oxf2af0[0x4]]
};
let krnhjzl = process[__Oxf2af0[0x5]][__Oxf2af0[0x6]] ? process[__Oxf2af0[0x5]][__Oxf2af0[0x6]] : __Oxf2af0[0x7];
let cookiesArr = [];
if ($[__Oxf2af0[0x0]]()) {
    Object[__Oxf2af0[0xa]](jdCookieNode)[__Oxf2af0[0x9]]((_0x4a25x7) => {
        cookiesArr[__Oxf2af0[0x8]](jdCookieNode[_0x4a25x7])
    });
    if (process[__Oxf2af0[0x5]][__Oxf2af0[0xb]] && process[__Oxf2af0[0x5]][__Oxf2af0[0xb]] === __Oxf2af0[0x7]) {
        console[__Oxf2af0[0xc]] = () => {}
    }
} else {
    cookiesArr = [$[__Oxf2af0[0xf]](__Oxf2af0[0xe]), $[__Oxf2af0[0xf]](__Oxf2af0[0x10]), ...$[__Oxf2af0[0x15]]($[__Oxf2af0[0xf]](__Oxf2af0[0x13]) || __Oxf2af0[0x14])[__Oxf2af0[0x12]]((_0x4a25x7) => {
        return _0x4a25x7[__Oxf2af0[0x11]]
    })][__Oxf2af0[0xd]]((_0x4a25x7) => {
        return !!_0x4a25x7
    })
};
let cookie = __Oxf2af0[0x2];
$[__Oxf2af0[0x16]] = __Oxf2af0[0x2];
$[__Oxf2af0[0x17]] = true;
const hour = new Date()[__Oxf2af0[0x18]]();
!(async() => {
    if (!cookiesArr[0x0]) {
        $[__Oxf2af0[0x22]]($[__Oxf2af0[0x1c]], __Oxf2af0[0x20], __Oxf2af0[0x21], {
            "open-url": __Oxf2af0[0x21]
        });
        return
    };
    $[__Oxf2af0[0x23]] = Date[__Oxf2af0[0x24]]();
    if ($[__Oxf2af0[0x23]] > endTime) {
        console[__Oxf2af0[0xc]](__Oxf2af0[0x25] + endTime);
        console[__Oxf2af0[0xc]](__Oxf2af0[0x26] + $[__Oxf2af0[0x23]]);
        return
    };
    authorCodeList = await getAuthorCodeList(__Oxf2af0[0x27]);
    if ($[__Oxf2af0[0x17]] == false) {
        let _0x4a25xb = __Oxf2af0[0x28];
        authorCodeList = Buffer[__Oxf2af0[0x2c]](_0x4a25xb, __Oxf2af0[0x2b]).toString()[__Oxf2af0[0x2a]](__Oxf2af0[0x29])
    };
    for (let _0x4a25xc = 0; _0x4a25xc < cookiesArr[__Oxf2af0[0x2d]]; _0x4a25xc++) {
        if (cookiesArr[_0x4a25xc]) {
            cookie = cookiesArr[_0x4a25xc];
            $[__Oxf2af0[0x2e]] = decodeURIComponent(cookie[__Oxf2af0[0x2f]](/pt_pin=([^; ]+)(?=;?)/) && cookie[__Oxf2af0[0x2f]](/pt_pin=([^; ]+)(?=;?)/)[0x1]);
            $[__Oxf2af0[0x30]] = _0x4a25xc + 1;
            $[__Oxf2af0[0x31]] = true;
            $[__Oxf2af0[0x32]] = __Oxf2af0[0x2];
            if (!$[__Oxf2af0[0x31]]) {
                if ($[__Oxf2af0[0x0]]()) {};
                continue
            };
            $[__Oxf2af0[0x33]] = __Oxf2af0[0x2];
            await main()
        }
    }
})()[__Oxf2af0[0x1f]]((_0x4a25xa) => {
    $[__Oxf2af0[0xc]](__Oxf2af0[0x2], `${__Oxf2af0[0x1b]}${$[__Oxf2af0[0x1c]]}${__Oxf2af0[0x1d]}${_0x4a25xa}${__Oxf2af0[0x1e]}`, __Oxf2af0[0x2])
})[__Oxf2af0[0x1a]](() => {
    $[__Oxf2af0[0x19]]()
});
async function main() {
    redCode = authorCodeList[Math[__Oxf2af0[0x35]]((Math[__Oxf2af0[0x34]]() * authorCodeList[__Oxf2af0[0x2d]]))];
    $[__Oxf2af0[0x36]] = redCode;
    let _0x4a25xe = decodeURIComponent(cookie[__Oxf2af0[0x2f]](/pt_pin=(.+?);/) && cookie[__Oxf2af0[0x2f]](/pt_pin=(.+?);/)[0x1]);
    $[__Oxf2af0[0x37]] = await getUa();
    $[__Oxf2af0[0x38]] = false;
    $[__Oxf2af0[0x39]] = false;
    for (let _0x4a25xc = 0; _0x4a25xc < 2 && !$[__Oxf2af0[0x38]]; _0x4a25xc++) {
        $[__Oxf2af0[0x3a]] = __Oxf2af0[0x2];
        $[__Oxf2af0[0x3b]] = __Oxf2af0[0x2];
        $[__Oxf2af0[0x3c]] = __Oxf2af0[0x2];
        $[__Oxf2af0[0x3d]] = __Oxf2af0[0x2];
        $[__Oxf2af0[0x3e]] = __Oxf2af0[0x2];
        if ($[__Oxf2af0[0x33]] === __Oxf2af0[0x3f]) {
            continue
        };
        await getInfo1();
        if (!$[__Oxf2af0[0x3c]]) {
            console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${_0x4a25xe}${__Oxf2af0[0x40]}`);
            $[__Oxf2af0[0x39]] = true;
            break
        };
        await getInfo2();
        if (!$[__Oxf2af0[0x3d]]) {
            console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${_0x4a25xe}${__Oxf2af0[0x41]}`);
            $[__Oxf2af0[0x39]] = true;
            break
        };
        $[__Oxf2af0[0x42]] = $[__Oxf2af0[0x3d]][__Oxf2af0[0x2f]](/mall\/active\/([^/]+)\/index\.html/) && $[__Oxf2af0[0x3d]][__Oxf2af0[0x2f]](/mall\/active\/([^/]+)\/index\.html/)[0x1] || __Oxf2af0[0x43];
        let _0x4a25xf = await getBody($.UA, $[__Oxf2af0[0x3d]]);
        await getEid(_0x4a25xf);
        if ($[__Oxf2af0[0x3e]]) {
            if (_0x4a25xc === 0 && $[__Oxf2af0[0x16]]) {
                await getCoupons($[__Oxf2af0[0x16]])
            } else {
                await getCoupons(__Oxf2af0[0x2])
            }
        };
        await $[__Oxf2af0[0x44]](parseInt(Math[__Oxf2af0[0x34]]() * 1000 + 500, 10))
    };
    if (krnhjzl == __Oxf2af0[0x45]) {
        if ($[__Oxf2af0[0x30]] === 1 && !$[__Oxf2af0[0x39]]) {
            await $[__Oxf2af0[0x44]](parseInt(Math[__Oxf2af0[0x34]]() * 1000 + 500, 10));
            await mainInfo()
        }
    }
...
function mainInfo() {
    return new Promise((_0x4a25x11) => {
        let _0x4a25x12 = {
            url: `${__Oxf2af0[0x46]}${Date[__Oxf2af0[0x24]]()}${__Oxf2af0[0x47]}${$[__Oxf2af0[0x42]]}${__Oxf2af0[0x48]}${$[__Oxf2af0[0x16]]}${__Oxf2af0[0x49]}${$[__Oxf2af0[0x36]]}${__Oxf2af0[0x4a]}${$[__Oxf2af0[0x3e]]}${__Oxf2af0[0x4b]}`,
            headers: {
                "Accept-Language": __Oxf2af0[0x4c],
                "Accept-Encoding": __Oxf2af0[0x4d],
                'Cookie': `${__Oxf2af0[0x2]}${cookie}${__Oxf2af0[0x4e]}${$[__Oxf2af0[0x3b]]}${__Oxf2af0[0x4e]}${$[__Oxf2af0[0x3a]]}${__Oxf2af0[0x2]}`,
                "User-Agent": $[__Oxf2af0[0x37]]
            }
        };
        $[__Oxf2af0[0x55]](_0x4a25x12, async(_0x4a25x13, _0x4a25x14, _0x4a25x15) => {
            try {
                if (_0x4a25x13) {
                    console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x4f]](_0x4a25x13)}${__Oxf2af0[0x2]}`)
                } else {
                    let _0x4a25x16 = $[__Oxf2af0[0x15]](_0x4a25x15, _0x4a25x15);
                    if (typeof _0x4a25x16 == __Oxf2af0[0x50]) {
                        if (_0x4a25x16[__Oxf2af0[0x36]] == 0 && _0x4a25x16[__Oxf2af0[0x51]] && _0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x52]]) {
                            $[__Oxf2af0[0x16]] = _0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x52]][__Oxf2af0[0x2f]](/\?s=([^&]+)/) && _0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x52]][__Oxf2af0[0x2f]](/\?s=([^&]+)/)[0x1] || __Oxf2af0[0x2];
                            console[__Oxf2af0[0xc]]($[__Oxf2af0[0x2e]] + __Oxf2af0[0x53] + $[__Oxf2af0[0x16]])
                        }
                    } else {
                        console[__Oxf2af0[0xc]](_0x4a25x15)
                    }
                }
            } catch (e) {
                $[__Oxf2af0[0x54]](e, _0x4a25x14)
            } finally {
                _0x4a25x11()
            }
        })
...
function getEid(_0x4a25xf) {
    return new Promise((_0x4a25x11) => {
        const _0x4a25x18 = {
            url: `${__Oxf2af0[0x56]}${_0x4a25xf[__Oxf2af0[0x57]]}${__Oxf2af0[0x2]}`,
            body: `${__Oxf2af0[0x58]}${_0x4a25xf[__Oxf2af0[0x59]]}${__Oxf2af0[0x2]}`,
            headers: {
                "Content-Type": __Oxf2af0[0x5a],
                "User-Agent": $[__Oxf2af0[0x37]]
            }
        };
        $[__Oxf2af0[0x5f]](_0x4a25x18, async(_0x4a25x13, _0x4a25x14, _0x4a25x15) => {
            try {
                if (_0x4a25x13) {
                    throw new Error(_0x4a25x13)
                } else {
                    if (_0x4a25x15[__Oxf2af0[0x5c]](__Oxf2af0[0x5b]) > 0) {
                        _0x4a25x15 = _0x4a25x15[__Oxf2af0[0x2a]](__Oxf2af0[0x5b], 2);
                        _0x4a25x15 = JSON[__Oxf2af0[0x5d]](_0x4a25x15[0x1]);
                        $[__Oxf2af0[0x3e]] = _0x4a25x15[__Oxf2af0[0x3e]]
                    } else {
                        console[__Oxf2af0[0xc]](`${__Oxf2af0[0x5e]}`)
                    }
                }
            } catch (e) {
                $[__Oxf2af0[0x54]](e, _0x4a25x14)
            } finally {
                _0x4a25x11(_0x4a25x15)
            }
        })
    })
}

function randomString(_0x4a25xa) {
    _0x4a25xa = _0x4a25xa || 32;
    let _0x4a25x1a = __Oxf2af0[0x60],
        _0x4a25x1b = _0x4a25x1a[__Oxf2af0[0x2d]],
        _0x4a25x1c = __Oxf2af0[0x2];
    for (i = 0; i < _0x4a25xa; i++) {
        _0x4a25x1c += _0x4a25x1a[__Oxf2af0[0x61]](Math[__Oxf2af0[0x35]](Math[__Oxf2af0[0x34]]() * _0x4a25x1b))
    };
    return _0x4a25x1c
}

function getAuthorCodeList(_0x4a25x1e) {
    return new Promise((_0x4a25x11) => {
        const _0x4a25x18 = {
            url: `${__Oxf2af0[0x2]}${_0x4a25x1e}${__Oxf2af0[0x62]}${ new Date()}${__Oxf2af0[0x2]}`,
            timeout: 10000,
            headers: {
                "User-Agent": __Oxf2af0[0x63]
            }
        };
        $[__Oxf2af0[0x55]](_0x4a25x18, async(_0x4a25x13, _0x4a25x14, _0x4a25x15) => {
            try {
                if (_0x4a25x13) {
                    $[__Oxf2af0[0x17]] = false
                } else {
                    if (_0x4a25x15) {
                        _0x4a25x15 = JSON[__Oxf2af0[0x5d]](_0x4a25x15)
                    };
                    $[__Oxf2af0[0x17]] = true
                }
            } catch (e) {
...
function random(_0x4a25x20, _0x4a25x21) {
    return Math[__Oxf2af0[0x35]](Math[__Oxf2af0[0x34]]() * (_0x4a25x21 - _0x4a25x20)) + _0x4a25x20
}

function getHash() {
    const _0x4a25x23 = new Array(9)[__Oxf2af0[0x64]](1)[__Oxf2af0[0x12]]((_0x4a25x7, _0x4a25x24) => {
        if (_0x4a25x24) {
            return random(0, 9)
        };
        return 1
    });
    return _0x4a25x23[__Oxf2af0[0x65]](__Oxf2af0[0x2])
}

function getCookieStr(_0x4a25x26, _0x4a25x27) {
    if (!_0x4a25x26[__Oxf2af0[0x66]]) {
        _0x4a25x26[__Oxf2af0[0x66]] = []
    };
    if (_0x4a25x26[__Oxf2af0[0x66]][__Oxf2af0[0x2d]] > 4) {
        return _0x4a25x26[__Oxf2af0[0x66]][random(0, _0x4a25x26[__Oxf2af0[0x66]][__Oxf2af0[0x2d]])]
    };
    let _0x4a25x28 = getHash();
    let _0x4a25x29 = new Date()[__Oxf2af0[0x67]]() + __Oxf2af0[0x2] + parseInt(2147483647 * Math[__Oxf2af0[0x34]]());
    let _0x4a25x2a = _0x4a25x29[__Oxf2af0[0x68]](0, 10);
    let _0x4a25x2b = 1;
    let _0x4a25x2c = [_0x4a25x28, _0x4a25x29, _0x4a25x2a, _0x4a25x2a, _0x4a25x2a, _0x4a25x2b][__Oxf2af0[0x65]](__Oxf2af0[0x69]);
    let _0x4a25x2d = `${__Oxf2af0[0x6a]}${_0x4a25x2c}${__Oxf2af0[0x6b]}${_0x4a25x28}${__Oxf2af0[0x6c]}`;
    _0x4a25x26[__Oxf2af0[0x66]][__Oxf2af0[0x8]](_0x4a25x2d);
    return _0x4a25x2d
}
async function getCoupons(_0x4a25x2f) {
    return new Promise(async(_0x4a25x11) => {
        const _0x4a25x30 = {
            platform: 1,
            unionActId: __Oxf2af0[0x6d],
            actId: $[__Oxf2af0[0x42]],
            d: $[__Oxf2af0[0x36]],
            unionShareId: _0x4a25x2f,
            type: 1,
            eid: $[__Oxf2af0[0x3e]]
        };
        const _0x4a25x31 = {
            appid: __Oxf2af0[0x6e],
            functionId: __Oxf2af0[0x6f],
            client: __Oxf2af0[0x70],
            clientVersion: __Oxf2af0[0x71],
            body: _0x4a25x30
        };
        const _0x4a25x32 = await getH5st(__Oxf2af0[0x72], _0x4a25x31);
        let _0x4a25x12 = {
            url: `${__Oxf2af0[0x73]}${_0x4a25x31[__Oxf2af0[0x74]]}${__Oxf2af0[0x75]}${_0x4a25x31[__Oxf2af0[0x76]]}${__Oxf2af0[0x77]}${Date[__Oxf2af0[0x24]]()}${__Oxf2af0[0x78]}${encodeURIComponent(JSON[__Oxf2af0[0x79]](_0x4a25x30))}${__Oxf2af0[0x7a]}${_0x4a25x31[__Oxf2af0[0x7b]]}${__Oxf2af0[0x7c]}${_0x4a25x31[__Oxf2af0[0x7d]]}${__Oxf2af0[0x7e]}${encodeURIComponent(_0x4a25x32)}${__Oxf2af0[0x2]}`,
            headers: {
                "Accept-Language": __Oxf2af0[0x4c],
                "Accept-Encoding": __Oxf2af0[0x4d],
                'Cookie': `${__Oxf2af0[0x2]}${cookie}${__Oxf2af0[0x4e]}${$[__Oxf2af0[0x3b]]}${__Oxf2af0[0x4e]}${$[__Oxf2af0[0x3a]]}${__Oxf2af0[0x2]}`,
        ...
        $[__Oxf2af0[0x55]](_0x4a25x12, async(_0x4a25x13, _0x4a25x14, _0x4a25x15) => {
            try {
                if (_0x4a25x13) {
                    console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x4f]](_0x4a25x13)}${__Oxf2af0[0x2]}`);
                    console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x1c]]}${__Oxf2af0[0x7f]}`)
                } else {
                    let _0x4a25x16 = $[__Oxf2af0[0x15]](_0x4a25x15, _0x4a25x15);
                    if (typeof _0x4a25x16 == __Oxf2af0[0x50]) {
                        if (_0x4a25x16[__Oxf2af0[0x22]]) {
                            console[__Oxf2af0[0xc]]($[__Oxf2af0[0x2e]] + __Oxf2af0[0x80] + _0x4a25x16[__Oxf2af0[0x22]]);
                            $[__Oxf2af0[0x33]] = _0x4a25x16[__Oxf2af0[0x22]]
                        };
                        if (_0x4a25x16[__Oxf2af0[0x22]][__Oxf2af0[0x5c]](__Oxf2af0[0x81]) !== -1) {
                            $[__Oxf2af0[0x38]] = true
                        };
                        if ($[__Oxf2af0[0x82]] && typeof _0x4a25x16[__Oxf2af0[0x51]] !== __Oxf2af0[0x83] && typeof _0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x84]] !== __Oxf2af0[0x83]) {
                            console[__Oxf2af0[0xc]](`${__Oxf2af0[0x85]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x86]]}${__Oxf2af0[0x87]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x84]]}${__Oxf2af0[0x2]}`)
                        };
                        if (_0x4a25x16[__Oxf2af0[0x36]] == 0 && _0x4a25x16[__Oxf2af0[0x51]]) {
                            if (_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x88]] == 1) {
                                console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x2e]]}${__Oxf2af0[0x89]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8a]]}${__Oxf2af0[0x8b]}`)
                            } else {
                                if (_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x88]] == 3) {
                                    console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x2e]]}${__Oxf2af0[0x8c]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8d]]}${__Oxf2af0[0x8e]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8a]]}${__Oxf2af0[0x2]}`)
                                } else {
                                    if (_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x88]] == 6) {
                                        console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x2e]]}${__Oxf2af0[0x8f]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8d]]}${__Oxf2af0[0x90]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8a]]* 10}${__Oxf2af0[0x91]}`)
                                    } else {
                                        console[__Oxf2af0[0xc]](`${__Oxf2af0[0x2]}${$[__Oxf2af0[0x2e]]}${__Oxf2af0[0x92]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8d]]|| __Oxf2af0[0x2]}${__Oxf2af0[0x4e]}${_0x4a25x16[__Oxf2af0[0x51]][__Oxf2af0[0x8a]]}${__Oxf2af0[0x2]}`);
                                        console[__Oxf2af0[0xc]](_0x4a25x15)
                                    }
                                }
                            }
...
async function getInfo2() {
    return new Promise((_0x4a25x11) => {
        ...
        $[__Oxf2af0[0x55]](_0x4a25x18, async(_0x4a25x13, _0x4a25x14, _0x4a25x15) => {
            try {
                let _0x4a25x34 = _0x4a25x14 && _0x4a25x14[__Oxf2af0[0x93]] && (_0x4a25x14[__Oxf2af0[0x93]][__Oxf2af0[0x94]] || _0x4a25x14[__Oxf2af0[0x93]][__Oxf2af0[0x95]] || __Oxf2af0[0x2]) || __Oxf2af0[0x2];
                let _0x4a25x35 = __Oxf2af0[0x2];
                if (_0x4a25x34) {
                    if (typeof _0x4a25x34 != __Oxf2af0[0x50]) {
                        _0x4a25x35 = _0x4a25x34[__Oxf2af0[0x2a]](__Oxf2af0[0x29])
                    } else {
                        _0x4a25x35 = _0x4a25x34
                    };
                    for (let _0x4a25x27 of _0x4a25x35) {
                        let _0x4a25x36 = _0x4a25x27[__Oxf2af0[0x2a]](__Oxf2af0[0x6c])[0x0][__Oxf2af0[0x96]]();
                        if (_0x4a25x36[__Oxf2af0[0x2a]](__Oxf2af0[0x97])[0x1]) {
                            if ($[__Oxf2af0[0x3a]][__Oxf2af0[0x5c]](_0x4a25x36[__Oxf2af0[0x2a]](__Oxf2af0[0x97])[0x1]) == -1) {
                                $[__Oxf2af0[0x3a]] += _0x4a25x36[__Oxf2af0[0x98]](/ /g, __Oxf2af0[0x2]) + __Oxf2af0[0x99]
                            }
                        }
                    }
                };
                $[__Oxf2af0[0x3d]] = _0x4a25x14 && _0x4a25x14[__Oxf2af0[0x93]] && (_0x4a25x14[__Oxf2af0[0x93]][__Oxf2af0[0x9a]] || _0x4a25x14[__Oxf2af0[0x93]][__Oxf2af0[0x9b]] || __Oxf2af0[0x2]) || __Oxf2af0[0x2];
                $[__Oxf2af0[0x3d]] = decodeURIComponent($[__Oxf2af0[0x3d]]);
                $[__Oxf2af0[0x3d]] = $[__Oxf2af0[0x3d]][__Oxf2af0[0x2f]](/(https:\/\/prodev\.m\.jd\.com\/mall[^'"]+)/) && $[__Oxf2af0[0x3d]][__Oxf2af0[0x2f]](/(https:\/\/prodev\.m\.jd\.com\/mall[^'"]+)/)[0x1] || __Oxf2af0[0x2]
            } catch (e) {
                $[__Oxf2af0[0x54]](e, _0x4a25x14)
            } finally {
                _0x4a25x11(_0x4a25x15)
...
async function getUa() {
    for (var _0x4a25x1a = __Oxf2af0[0x2], _0x4a25x1c = __Oxf2af0[0x9c], _0x4a25x38 = 0; _0x4a25x38 < 16; _0x4a25x38++) {
        var _0x4a25xc = Math[__Oxf2af0[0x9d]](Math[__Oxf2af0[0x34]]() * (_0x4a25x1c[__Oxf2af0[0x2d]] - 1));
        _0x4a25x1a += _0x4a25x1c[__Oxf2af0[0x9e]](_0x4a25xc, _0x4a25xc + 1)
    };
    uuid = Buffer[__Oxf2af0[0x2c]](_0x4a25x1a, __Oxf2af0[0x9f]).toString(__Oxf2af0[0x2b]);
    ep = encodeURIComponent(JSON[__Oxf2af0[0x79]]({
        "hdid": __Oxf2af0[0xa0],
        "ts": (new Date)[__Oxf2af0[0x67]](),
        "ridx": -1,
        "cipher": {
            "sv": __Oxf2af0[0xa1],
            "ad": uuid,
        ...
        "ciphertype": 5,
        "version": __Oxf2af0[0xa4],
        "appname": __Oxf2af0[0xa5]
    }));
    return `${__Oxf2af0[0xa6]}${ep}${__Oxf2af0[0xa7]}`
}
async function getInfo1() {
    $[__Oxf2af0[0x3b]] = getCookieStr($, cookie);
    return new Promise((_0x4a25x11) => {
        const _0x4a25x18 = {
            url: `${__Oxf2af0[0xa8]}${$[__Oxf2af0[0x36]]}${__Oxf2af0[0xa9]}${$[__Oxf2af0[0x16]]}${__Oxf2af0[0x2]}`,
            followRedirect: false,
            headers: {
                'Cookie': cookie,
                'user-agent': $[__Oxf2af0[0x37]]
        ...
        $[__Oxf2af0[0x55]](_0x4a25x18, async(_0x4a25x13, _0x4a25x14, _0x4a25x15) => {
            try {
                ...
                $[__Oxf2af0[0x3c]] = _0x4a25x15[__Oxf2af0[0x2f]](/(https:\/\/u\.jd\.com\/jda[^']+)/) && _0x4a25x15[__Oxf2af0[0x2f]](/(https:\/\/u\.jd\.com\/jda[^']+)/)[0x1] || __Oxf2af0[0x2]
            } catch (e) {
                $[__Oxf2af0[0x54]](e, _0x4a25x14)
            } finally {
                _0x4a25x11(_0x4a25x15)
...
}(function(_0x4a25x3a, _0x4a25x3b, _0x4a25x3c, _0x4a25x3d, _0x4a25x3e, _0x4a25x3f) {
    _0x4a25x3f = __Oxf2af0[0x83];
    _0x4a25x3d = function(_0x4a25x40) {
        if (typeof alert !== _0x4a25x3f) {
            alert(_0x4a25x40)
        };
        if (typeof console !== _0x4a25x3f) {
            console[__Oxf2af0[0xc]](_0x4a25x40)
        }
    };
    _0x4a25x3c = function(_0x4a25x1b, _0x4a25x3a) {
        return _0x4a25x1b + _0x4a25x3a
    };
    _0x4a25x3e = _0x4a25x3c(__Oxf2af0[0xaa], _0x4a25x3c(_0x4a25x3c(__Oxf2af0[0xab], __Oxf2af0[0xac]), __Oxf2af0[0xad]));
    try {
        _0x4a25x3a = __encode;
        if (!(typeof _0x4a25x3a !== _0x4a25x3f && _0x4a25x3a === _0x4a25x3c(__Oxf2af0[0xae], __Oxf2af0[0xaf]))) {
            _0x4a25x3d(_0x4a25x3e)
        }
    } catch (e) {
        _0x4a25x3d(_0x4a25x3e)
    }
