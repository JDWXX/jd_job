...
!(async () => {
    ...
    for (let i = 0; i < 2; i++) {
        if (cookiesArr[i]) {
            ...
            console.log("\n开始")
            await fetch("https://lzkjdz-isv.isvjcloud.com/wxCommonInfo/token", {
                "headers": {
                    ...
                    "Referer": "https://lzkjdz-isv.isvjcloud.com/m/common/nestle/invite/?token=10108EF6C827C94ADAA5C63D45860294BD61B9422637C2E963089D37AE525F4B&venderId=1000225742&activityId=5a64d157a9cc46f390d65765fd7dd8cb&helpUuid=53ac2977639947fbb8ae53b0cd650a06&sid=de167ceb6abbbe89b9aef1085689d65w&un_area=15_1213_3410_71720",
