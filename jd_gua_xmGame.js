...
第一个CK失效会退出脚本
————————————————
入口：[8.13-8.31 小米-星空大冒险 (https://lzdz1-isv.isvjcloud.com/dingzhi/xiaomi/gameupd/activity/1272964?activityId=dz2108100000412302&shareUuid=dc710f05b3e04e719ef5e5687e2dad20)]
============Quantumultx===============
[task_local]
#8.13-8.31 小米-星空大冒险
...
let stopIndex = cookiesArr.length
if($.isNode()){
...
!(async () => {
    ...
    $.shareUuid = 'dc710f05b3e04e719ef5e5687e2dad20'
