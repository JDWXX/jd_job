...
[task_local]
#中青看点分享阅读
0 30 9 * * * https://github.com/JDWXX/jd_job/blob/master/qt/zqkd/jd_zqkd_shareRead.js, tag=中青看点分享阅读, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 30 9 * * *" script-path=https://github.com/JDWXX/jd_job/blob/master/qt/zqkd/jd_zqkd_shareRead.js,tag=中青看点分享阅读

===============Surge=================
中青看点分享阅读 = type=cron,cronexp="0 30 9 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/jd_job/blob/master/qt/zqkd/jd_zqkd_shareRead.js
