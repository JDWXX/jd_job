...
!(async() => {
    if (!cookiesArr[0x0]) {
        $[__Oxefa4f[0x28]]($[__Oxefa4f[0x25]], __Oxefa4f[0x26], __Oxefa4f[0x27], {
            "\x6F\x70\x65\x6E\x2D\x75\x72\x6C": __Oxefa4f[0x27]
        });
        return
    };
    ...
    for (let _0xd0e4x11 = 0; _0xd0e4x11 < ids[__Oxefa4f[0x29]]; _0xd0e4x11++) {
        ...
        for (let _0xd0e4x12 = 0; _0xd0e4x12 < cookiesArr[__Oxefa4f[0x29]]; _0xd0e4x12++) {
            ...
            if (cookie) {
                ...
                if (!$[__Oxefa4f[0x39]]) {
                    $[__Oxefa4f[0x28]]($[__Oxefa4f[0x25]], `${__Oxefa4f[0x3d]}`, `${__Oxefa4f[0x3e]}${$[__Oxefa4f[0x36]]}${__Oxefa4f[0x3f]}${$[__Oxefa4f[0x38]]|| $[__Oxefa4f[0x34]]}${__Oxefa4f[0x40]}`, {
                        "\x6F\x70\x65\x6E\x2D\x75\x72\x6C": __Oxefa4f[0x41]
                    });
                    if ($[__Oxefa4f[0xa]]()) {};
                    continue
                };
...
function randomString(_0xd0e4x10) {
    ...
    let _0xd0e4x30 = __Oxefa4f[0xd4],
        _0xd0e4x31 = _0xd0e4x30[__Oxefa4f[0x29]],
        _0xd0e4x32 = __Oxefa4f[0x0];
...
function getCard(_0xd0e4x3b) {
    return new Promise((_0xd0e4x1e) => {
        $[__Oxefa4f[0xcb]]({
            ...
            headers: {
                "\x55\x73\x65\x72\x2D\x41\x67\x65\x6E\x74": ver2
            },
            timeout: 99000
...
function getToken() {
    return new Promise((_0xd0e4x1e) => {
        $[__Oxefa4f[0xcb]]({
            ...
            headers: {
                "\x55\x73\x65\x72\x2D\x41\x67\x65\x6E\x74": ver1
            },
            timeout: 99000
        }, (_0xd0e4x1f, _0xd0e4x20, _0xd0e4x21) => {
            try {
...
Date[__Oxefa4f[0x10b]][__Oxefa4f[0x10a]] = function(_0xd0e4x4b) {
    var _0xd0e4x10, _0xd0e4x32 = this,
        _0xd0e4x4c = _0xd0e4x4b,
        _0xd0e4x4d = {
