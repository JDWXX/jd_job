...
[task_local]
#穿行寻宝-膨胀
10 20 * * *  https://github.com/JDWXX/jd_job.git, tag=穿行寻宝-膨胀, enabled=true

================Loon==============
[Script]
cron "10 20 * * * " script-path=https://github.com/JDWXX/jd_job.git,tag=穿行寻宝-膨胀

===============Surge=================
穿行寻宝-膨胀 = type=cron,cronexp="10 20 * * * ",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/jd_job.git

============小火箭=========
穿行寻宝-膨胀 = type=cron,script-path=https://github.com/JDWXX/jd_job.git, cronexpr="10 20 * * * ", timeout=3600, enable=true
 */
