...
const $ = new Env("超店会员福利社_11.11-11.12");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityId = 'dz211026100001616201'
            $.activityShopId = '1000008983'
            $.activityUrl = `https://lzdz1-isv.isvjd.com/dingzhi/shop/league/activity?activityId=${$.activityId}&shareUuid=${encodeURIComponent($.authorCode)}&adsource=null&shareuserid4minipg=null&shopid=${$.activityShopId}&lng=00.000000&lat=00.000000&sid=&un_area=`
            await rush();
            await $.wait(1000)
