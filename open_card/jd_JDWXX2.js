/*
1.6~1.14 瓜分千万京豆_2 [jd_JDWXX2.js]
开卡脚本，一次性脚本
第一个账号助力作者 其他依次助力CK1
第一个CK失效会退出脚本
cron:50 0,13 6-14 1 *
...
[task_local]
#1.6~1.14 瓜分千万京豆_2
50 0,13 6-14 1 * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_JDWXX2.js, tag=1.6~1.14 瓜分千万京豆_2, enabled=true
*/
const $ = new Env('1.6~1.14 瓜分千万京豆_2');
...
!(async () => {
    ...
    console.log(`\n活动地址:https://jinggengjcq-isv.isvjcloud.com/fronth5/#/pages/unitedCardNew20220110/unitedCardNew20220110?actId=3a3db8e8af354bb9b69d6a_220110&bizExtString=c2hhcmVOaWNrOmsxTm9iYiUyQlAwZXIlMkJDMnN5c3hueCUyRlAyS0VMTzlpelJWcHdDeXF1MGVxVlo1YVc3Ukh6bE1vYnJ6SiUyRmU5ciUyRnVm`)
