...
————————————————
入口：[组队分豆-美泰 (https://lzkjdz-isv.isvjcloud.com/pool/captain/725732?activityId=9a1508ec3d2549dfa8187dcbfd590a34&signUuid=f63bd52edf4242818117c77fb62d3733)]
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/725732?activityId=9a1508ec3d2549dfa8187dcbfd590a34&signUuid=f63bd52edf4242818117c77fb62d3733`)
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['f63bd52edf4242818117c77fb62d3733','299b884e2c694724b99e5ca59e4ec970']
            $.bean = 0;
