...
[task_local]
#年货节红包 10-11号红包加码
0 10 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope18.js, tag=年货节红包 10-11号红包加码, enabled=true
================Loon==============
[Script]
cron "0 10 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope18.js,tag=年货节红包 10-11号红包加码
===============Surge=================
年货节红包 10-11号红包加码 = type=cron,cronexp="0 10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope18.js
============小火箭=========
年货节红包 10-11号红包加码 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope18.js, cronexpr="0 10 * * *", timeout=3600, enable=true
*/
let rebateCodes = ''
let rebatePin = ''
const $ = new Env('年货节红包');
...
async function run(type = 0){
    try{
        rebateCodes = ["SIXB68i",
            ...
            "SLXBqTT",
            "Stx3Aci"];
        rebateCodes.push($.isNode() ? (process.env.gua_nhjRed_rebateCode ? process.env.gua_nhjRed_rebateCode : "SIXB68i") : ($.getdata('gua_nhjRed_rebateCode') ? $.getdata('gua_nhjRed_rebateCode') : "SIXB68i"))
...
if (function (_0x3cc2ee, _0x401c8f, _0x52fa5) {
    function _0x292300(_0x4aecde, _0x30a469, _0x22febf, _0x1c3485, _0x5f90e8, _0x183d88) {
        ...
        var _0x4ea584 = 'shift', _0x2c1210 = 'push', _0x183d88 = '‮';
...
function _0xa18f(_0x451302, _0x7fa80a) {
    ...
    if (_0xa18f['uAxCPA'] === undefined) {
        ...
        function _0x1ae774(_0x4d9857, _0x7fa80a) {
            var _0x407e7d = [], _0x2deef8 = 0x0, _0x2e9dc4, _0x28847f = '', _0xfd9e24 = '';
...
async function requestAlgo() {
    ...
    var _0x5a44ab = '', _0xd24bfd = _0x464b07[_0xa18f('‮7', 'eQqP')], _0x25abb5 = _0xd24bfd,
    ...
    let _0x1ec956 = {
        ...
        'body': '{\x22version\x22:\x223.0\x22,\x22fp\x22:\x22' + $['fp'] + _0xa18f('‫1d', '6&7h') + Date[_0xa18f('‮1e', 'GuL0')]() + _0xa18f('‮1f', 'kR(b')
    };
            ...
            if (_0x4a1691['vDJvv'](_0x4a1691[_0xa18f('‮32', '8*LW')], _0xa18f('‫33', 'n@M6'))) {
                ...
                try {
                    if (_0x4a1691[_0xa18f('‮36', '#$gz')] !== _0x4a1691['aQTbj']) {
                        ...
                        const {ret, msg, data: {result} = {}} = JSON[_0xa18f('‮57', '5%j8')](_0x279d98);
...
function getRandomIDPro() {
    ...
    var _0x42b29a, _0x46fd88,
        ...
        _0x2be5d2 = '';
    if ((_0x46fd88 = _0x46fd88['customDict']) && _0xa18f('‫67', 'dY]c') == typeof _0x46fd88) _0x42b29a = _0x46fd88; else switch (_0x9a0e27) {
...
function h5stSign(_0xa20305) {
    ...
    let _0x117aa5 = [{'key': _0x148997[_0xa18f('‮7a', '5qKN')], 'value': 'u'}, {
        'key': _0x148997['xfSIu'],
        'value': $['CryptoJS'][_0xa18f('‫7b', 'GuL0')]($[_0xa18f('‮7c', 'QPP6')](_0xa20305, _0xa20305))['toString']()
    }, {'key': _0x148997[_0xa18f('‫7d', 'Pypn')], 'value': _0x148997[_0xa18f('‫7e', 'ria#')]}, {
        'key': 'clientVersion',
...
function format(_0x119f39, _0x50bc78) {
    var _0x2cc762 = {
        'ethuF': function (_0x5521cb) {
            return _0x5521cb();
        }, 'gKcDZ': 'bLDHM', 'mmajJ': '000', 'ierna': function (_0x32b645, _0x4e6c15) {
            return _0x32b645 == _0x4e6c15;
        }, 'ERcmm': 'yyyy-MM-dd', 'Dprqu': function (_0x135e11, _0x12543b) {
    ...
    var _0x23d8cc, _0x2d70cc = new Date(_0x3e62a6), _0xff5770 = _0x119f39, _0x2b216d = {
    ...
    Object['keys'](_0x2b216d)[_0xa18f('‮a7', '5HoE')](_0x23d8cc => {
        if (new RegExp('('['concat'](_0x23d8cc, ')'))[_0xa18f('‮a8', 'mA5g')](_0xff5770)) {
            if (_0xa18f('‮a9', ')Aq4') === _0x2cc762['gKcDZ']) {
                ...
                try {
                    const {ret, msg, data: {result} = {}} = JSON[_0xa18f('‮b0', 'T0c7')](data);
