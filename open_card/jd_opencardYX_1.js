...
[task_local]
#6.1-6.30 雅诗兰黛奢雅邀请入会有礼
41 10,21 6-30/2 6 * jd_opencardYX_1.js, tag=6.1-6.30 雅诗兰黛奢雅邀请入会有礼, enabled=true
...
!(async () => {
    ...
    $.shareUuid = ""
    console.log(`入口:\nhttps://lzkjdz-isv.isvjcloud.com/esteelauder/inviteNew/activityPage?activityId=2206100037674501&inviterUuid=${$.shareUuid}`)
    let shareUuidArr = []
