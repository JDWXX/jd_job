...
第一个CK失效会退出脚本
————————————————
入口：[ 12.20~1.5 双旦寻宝 玩转大富翁 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dfw2021121702rics9xrkw5mpka&shareUuid=8fa10c0d3f1f4f6bb425f126c45d0aca)]
请求太频繁会被黑ip
过10分钟再执行
...
!(async () => {
    ...
    $.shareUuid = "8fa10c0d3f1f4f6bb425f126c45d0aca"
...
async function takePostRequest(type) {
    ...
    switch (type) {
        ...
        case '助力':
            if(type == '助力'){
                authorCodeList = ["8fa10c0d3f1f4f6bb425f126c45d0aca",$.shareUuid,$.shareUuid]
