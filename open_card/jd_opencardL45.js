...
第一个CK失效会退出脚本
————————————————
入口：https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/6869761?activityId=dzlhkkkbblnt20220114&shareUuid=2743a2ea7ce74a80a0d3a130ae503d2c
请求太频繁会被黑ip
过10分钟再执行
cron:1 6,21 14-21 1 *
============Quantumultx===============
...
!(async () => {
    ...
    $.shareUuid = "2743a2ea7ce74a80a0d3a130ae503d2c"
