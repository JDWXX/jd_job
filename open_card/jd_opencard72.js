...
!(async () => {
    ...
    authorCodeList = [
        '6e411ee7a3f9499e8618a4d35acb6888',
        '27b388ae98a24a3a809ecb5a655f70ca',
    ]
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList.push(ownCode);
            authorCodeList.push(ownCode);
            authorCodeList.push("27b388ae98a24a3a809ecb5a655f70ca");
            authorCodeList.push("6e411ee7a3f9499e8618a4d35acb6888");
            $.authorCode = authorCodeList[random(0, authorCodeList.length)]
