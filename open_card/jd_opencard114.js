...
All变量适用
————————————————
入口：[ 2.19～2.26 奢宠会员 瓜分百万京豆 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=unionkbblnt20220218dzlhkk&shareUuid=751f3f4943764eb8a437e14313041be1)]
请求太频繁会被黑ip
过10分钟再执行
cron:30 1 19-26/3 2 *
============Quantumultx===============
...
!(async () => {
    ...
    $.shareUuid = "751f3f4943764eb8a437e14313041be1"
