/*
12.04~12.21 品质女装 年终钜惠 [jd_opencardLL8.js]
新增开卡脚本
一次性脚本
默认执行脚本。如果需要不执行
环境变量 NO_RUSH=false
...
第一个CK失效会退出脚本
————————————————
入口：[ 12.04~12.21 品质女装 年终钜惠 (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dzsdfkl20211204A&shareUuid=)]

请求太频繁会被黑ip
过10分钟再执行

cron:17 1,19 4-21 12 *
============Quantumultx===============
[task_local]
#12.04~12.21 品质女装 年终钜惠
17 1,19 4-21 12 * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_opencardLL8.js, tag=12.04~12.21 品质女装 年终钜惠, enabled=true

*/
const $ = new Env("12.04~12.21 品质女装 年终钜惠");
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/opencardLL8.json')
