...
第一个CK失效会退出脚本
————————————————
入口：[ 12.17~1.3 双旦寻宝 玩转大富翁 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dfw202112nw2thjcb1rl48x88v&shareUuid=4ead1cc5f1f9466c90a819b0697e02c9)]
请求太频繁会被黑ip
过10分钟再执行
...
!(async () => {
    ...
    $.shareUuid = "4ead1cc5f1f9466c90a819b0697e02c9"
...
async function takePostRequest(type) {
    ...
    switch (type) {
        ...
        case '助力':
            if(type == '助力'){
                authorCodeList = ["4ead1cc5f1f9466c90a819b0697e02c9"]
