/*
组队分豆-通用脚本 [jd_zdfd_all.js]

————————————————
入口：[组队分豆-通用脚本 (https://lzkjdz-isv.isvjcloud.com/pool/captain/15935?activityId=ecaf4a23237e403896efdc9507a31ea2&shareUuid=e74d11765ea54d238f85fc0518a2d768)]
IOS等用户直接用NobyDa的jd cookie
cron "1 0,7,12 * * *" script-path=jd_zdfd_all.js,tag=组队分豆-通用脚本
*/
const $ = new Env("组队分豆-通用脚本");
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
const notify = $.isNode() ? require('./sendNotify') : '';
let activityId = $.isNode() ? (process.env.zdfd_activityId ? process.env.zdfd_activityId : "85bd87e3bda047d78155139bcd8cb55b") : "85bd87e3bda047d78155139bcd8cb55b";
...
function getUserId() {
    const options = {
        url: "https://lzkjdz-isv.isvjd.com/pool/activityContent",
        "body": "activityId=" + activityId + "&pin=Fty5u2uFTXCQdS3%2FVUVyxutbtcOQ8PU6ameYGVhDwgBbcUEeOIeVj3s%2BUGdHPF0E&signUuid=",
        headers: {
            ...
            "cookie": cookiesArr[0],
            "Referer": "https://lzkjdz-isv.isvjd.com/pool/captain/15930?activityId=" + activityId,
...
!(async () => {
    ...
    authorCodeList = []
    // authorCodeList = await getAuthorCodeList('https://jdwxx.github.io/jd_job/zdfd_all.json').getValByKey("activityId")
    // if(authorCodeList === '404: Not Found'){
    //     authorCodeList = []
    // }
    if(authorCodeList.length > 0)
        console.log("若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/15935?activityId=" + activityId + "&shareUuid=" + authorCodeList[0])
    else
        console.log("若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/15935?activityId=" + activityId)
    await getUserId()
