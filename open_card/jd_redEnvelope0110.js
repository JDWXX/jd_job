...
[task_local]
#年货节红包 10-11号红包加码
55 59 23,7,11,20 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_nhjred.js, tag=年货节红包 10-11号红包加码, enabled=true
================Loon==============
[Script]
cron "55 59 23,7,11,20 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/d_nhjred.js,tag=年货节红包 10-11号红包加码
===============Surge=================
年货节红包 10-11号红包加码 = type=cron,cronexp="55 59 23,7,11,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/d_nhjred.js
============小火箭=========
年货节红包 10-11号红包加码 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/d_nhjred.js, cronexpr="55 59 23,7,11,20 * * *", timeout=3600, enable=true
*/
const $ = new Env('年货节红包 10-11号红包加码');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
const notify = $.isNode() ? require('./sendNotify') : '';
let rebateCodes = 'SMIsByU'
console.log("领红包：https://u.jd.com/SMIsByU")
...
!(async () => {
    ...
    const flCodeArr = ["SMq8rBd", "SLuygCx", "StuyrNh", "SLua6fE"];
    try{
...
function getUrl() {
    return new Promise(resolve => {
        if($.again == true) rebateCode = 'S'+'L'+'u'+'a'+'6'+'f'+'E'
        const options = {
