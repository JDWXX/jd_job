/*
1.6~1.14 瓜分千万京豆_1 [jd_JDWXX1.js]
开卡脚本，一次性脚本
第一个账号助力作者 其他依次助力CK1
第一个CK失效会退出脚本
cron:50 0,13 6-14 1 *
...
[task_local]
#1.6~1.14 瓜分千万京豆_1
50 0,13 6-14 1 * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_JDWXX1.js, tag=1.6~1.14 瓜分千万京豆_1, enabled=true
*/
const $ = new Env('1.6~1.14 瓜分千万京豆_1');
...
!(async () => {
    ...
    $.userId = '10299171'
    $.actId = '9b2e0e6119a44810934ad853_22011001'
    $.MixNicks = ''
    $.inviteNick = '/nFlfyWPdMnTxK1/nf0Ssc7TwJCmNe8NFvhpI0XmJDULVU108+UxlHw7qoUuHA4F'
    console.log(`\n活动地址:https://jinggengjcq-isv.isvjcloud.com/fronth5/#/pages/unitedCardNew20220106/unitedCardNew20220106?actId=9b2e0e6119a44810934ad853_22011001&bizExtString=c2hhcmVOaWNrOmsxTm9iYiUyQlAwZXIlMkJDMnN5c3hueCUyRlAyS0VMTzlpelJWcHdDeXF1MGVxVlo1YVc3Ukh6bE1vYnJ6SiUyRmU5ciUyRnVm`)
