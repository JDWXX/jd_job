...
[task_local]
#6.8~6.18 全力以赴 谁是囤货王
52 4,22 8-18 6 * jd_opencardL179.js, tag=6.8~6.18 全力以赴 谁是囤货王, enabled=true
*/
...
!(async () => {
    ...
    $.shareUuid = "47bbbe28b57b49caa319e6df4590e8b2"
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
    shareUuidArr = ["47bbbe28b57b49caa319e6df4590e8b2"]
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        if (cookie) {
            ...
            $.hotFlag = false
            $.nickName = '';
            $.shareUuid = shareUuidArr[random(0, shareUuidArr.length)];
