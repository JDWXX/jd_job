...
!(async () => {
    ...
    $.shareUuid = '5c24599884b34b62b5f2d56337ee2901';
    let shareList = [];
...
function takePostRequest(type) {
    ...
    switch (type) {
        ...
        case 'doTask':
            ...
            body = `activityId=${activityID}&actorUuid=${actorUuid}&param=${$.param}&taskType=${$.taskType}&pin=${encodeURIComponent(pin)}&shareUuid=5c24599884b34b62b5f2d56337ee2901`;
            break;
        case 'doTask2':
