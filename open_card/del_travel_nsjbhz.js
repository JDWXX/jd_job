/*
33 9,13 * * * jd_travel_nsjbhz.js
*/
const $ = new Env('年兽金币助力');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
//默认助力前一
let helpnum = $.isNode() ? (process.env.nsHelpnum ? process.env.nsHelpnum : 1) : ($.getdata('nsHelpnum') ? $.getdata('nsHelpnum') : 1);
...
!(async () => {
  ...
  console.log("脚本默认助力第一个，如您的ck足够多，可以添加环境变量 nsHelpnum 修改助力前几名，如 nsHelpnum 设置10 则助力前10")
  $.inviteIdCodesArr = {}
